...
incidents which had available spatial coordinates. Nominatim was used to reverse geocode, as I did not have access to APIs with faster and larger rate limits. Being a public API, Nominatim's
